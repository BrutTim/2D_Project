...
# Grundlage: ADAC-Broschuere "Verkehrszeichen in Deutschland", Abschnitt
# Vorschriftzeichen. Rechteckige/sonstige Zeichen sind im Manifest enthalten,
# werden vom aktuellen Outer-Shape-Klassifikator aber nur geladen, wenn ihr
# spaeter passende outer_type-Regeln ergaenzt.
